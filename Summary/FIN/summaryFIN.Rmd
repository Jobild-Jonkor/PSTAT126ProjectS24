...
```{r fig.cap = "Residual plot of the Ridge Regression"}
plot(1:500, ridge_model_y_predictions[,1]-ridge_model_y_predictions[,2], xlab="Fitted Model", ylab = "Residuals")
```
...
```{r fig.cap = "Residual plot of the Lasso Regression"}
plot(1:500, lasso_model_y_predictions[,1]-lasso_model_y_predictions[,2], xlab = "Fitted Model", ylab = "Residuals")
```
\newpage
...
We found that our data could be reduced to two principal components because they capture almost all of the variance of the predictors. Component one distributes weights about evenly across our predictors and component two puts emphasis on triples and stolen bases.
