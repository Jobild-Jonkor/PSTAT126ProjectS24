...
MSE_ridge <- (1/500) * sum((ridge_model_y_predictions[,2]-ridge_model_y_predictions[,1])^2)
MSE_ridge
```
...
MSE_lasso <- (1/500) * sum((lasso_model_y_predictions[,2]-lasso_model_y_predictions[,1])^2)
MSE_lasso
```
