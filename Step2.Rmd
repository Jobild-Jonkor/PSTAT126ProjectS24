...
We are 95% confident that the mean runs is between 184.75 and 228.45.
...
We are 95% confident that the mean runs when doubles is 200 is between 92.15 and 135.85.

# Fit of Model

The $R^2$ value of our model is 0.9551 and the adjusted $R^2$ is 0.955. This means that the model explains 95.51% of the variance of the recorded events. Additionally, the residual plot in figure 2 shows how the data points share a similar spread which implies that the model is a good fit. As a result, we conclude that this model fits our data well and explains the majority of the variation in the data.
